...
function TopMiddleSection({ fadeContent = false }) {
  ...
  return (
    <div className="w-full bg-linear-to-b from-app-primary-20 to-app-primary-bg py-20 font-sans overflow-hidden">
      <motion.div
      ...
      >
        ...
        <div className="mb-12 text-center pb-12">
          ...
          />
          <h2 className="text-4xl font-bold text-app-black-100">
            Wave GoodBye To
          </h2>
        </div>
            ...
            return (
              <div
                ...
                className={`
                  ...
                  ${
                    isActive
                      ? "z-30 opacity-100 scale-100 bg-app-primary-40 border-app-primary-60 shadow-xl"
                      : isNeighbor
                      ? "z-20 opacity-80 scale-95 bg-app-primary-40 border-[0.5px] border-app-primary-60 blur-[2px]"
                      : "z-10 opacity-30 scale-90 bg-app-primary-40 border-transparent blur-[2px]"
                  }
                `}
                style={{
