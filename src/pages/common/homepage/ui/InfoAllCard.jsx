...
const InfoAllCard = () => {
  ...
  return (
    <>
      ...
      >
        <div className="relative w-full max-w-md h-80 rounded-4xl shadow-[0_20px_40px_rgba(0,0,0,0.35)] p-8 border-3 border-app-primary-4">
          <div className="relative inline-block mb-6">
            {/* INNER GLOW UNDER S */}
            <div
              className="absolute -left-2 top-1 w-5 h-5 rounded-full backdrop-blur-md
                        shadow-[5px_12px_22px_rgba(0,0,0,0.25)] [box-shadow:5px_12px_22px_rgba(0,0,0,0.25),inset_4px_4px_4px_rgba(255,255,255,0.25)]"
            />
            {/* STUDENT TEXT */}
            <span className="relative z-10 text-app-primary-4 text-lg font-extrabold">
              Student
            </span>
          </div>
          {/* FEATURES */}
          <p className="text-app-primary-4 text-lg font-medium">
            Smart Practice <br />
            Instant feedback <br />
      ...
      >
        <div
          className="relative w-full max-w-md h-80 rounded-4xl
                             backdrop-blur-md
                            border-3 border-app-primary-4
        ...
        >
          ...
          />
          <p className="text-app-primary-4 text-lg font-medium text-right">
            Auto grading <br />
      ...
      <motion.div
        ...
        viewport={{ margin: "-50px" }}
      >
        <div className="relative w-full max-w-md h-80 rounded-4xl  backdrop-blur-md border-3 border-app-primary-4 shadow-[0_20px_40px_rgba(0,0,0,0.35)] p-8">
          ...
          {/* FEATURES (CENTER) */}
          <p className="mt-10 text-app-primary-4 text-lg font-medium">
