    ...
    <>
      <div className='relative flex flex-col md:flex-row justify-between items-center overflow-hidden py-18 md:py-40 bg-white'>
        ...
        <div className='absolute right-0 top-1/2 -translate-y-1/2 translate-x-1/4 md:translate-x-0 w-[420px] h-[420px] md:w-[690px] md:h-[690px] flex items-center justify-center -mr-80'>
          {/* Concentric Circles */}
          {/* Largest Circle */}
          <div className='absolute w-full h-full rounded-full bg-linear-to-br from-[#A1AEF2] to-[#514CF1] opacity-40 drop-shadow-2xl animate-[breathe_4s_ease-in-out_infinite]'></div>
          ...
          <div className='absolute w-full h-full animate-[oscillate_25s_ease-in-out_infinite]'>
            <div className='absolute top-[25%] right-[60%] bg-white/30 backdrop-blur-md p-4 rounded-xl shadow-lg border border-white/20 transform hover:scale-110 transition-transform duration-300 animate-[oscillate-reverse_25s_ease-in-out_infinite]'>
