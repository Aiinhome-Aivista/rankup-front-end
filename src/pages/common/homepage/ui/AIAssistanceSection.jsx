...
const AIAssistanceSection = () => {
    return (
        <div className='relative px-4 md:px-10 text-white py-10 bg-white'>
            ...
            <div className='relative z-10 w-[calc(100%-2rem)] max-w-5xl mx-auto flex flex-col items-center'>
                ...
                <div className='text-center mb-16'>
                    ...
                    <p className='text-lg font-normal text-white'>Experience the future of assessments with your own AI assistant!</p>
                </div>
                ...
                <div className='relative grid grid-cols-1 md:grid-cols-12 gap-6 w-full'>
                    ...
                    <div className='md:col-span-8'>
                        <div className='w-full h-full text-[#FFFFFF80] rounded-3xl px-6 pb-6 border-3 border-[#FFFFFF38] text-center backdrop-blur-xl shadow-[5px_12px_22px_4px_rgba(0,0,0,0.25)] flex flex-col items-center'>
                            <p className='text-[#FFFFFF80] text-lg font-normal mt-8'> At RankUp, we use Artificial Intelligence (AI) to transform the way students learn, practice, and succeed. Our AI-driven system personalizes learning, evaluates performance instantly, and provides deep insights to help students and educators make better decisions—faster.</p>

                            <button
                                className="mt-5 h-[33px] w-[118px] rounded-[20px]   text-[#D9D9D9]
                                                    text-lg
                                                    font-semibold
                                                    backdrop-blur-md
                                                    ...
                                                    hover:bg-white/10
                                                    hover:scale-[1.02]
                                                    active:scale-[0.98] cursor-pointer">Generate
                            </button>
                            <div
                                className="absolute -bottom-22 right-28 w-[23px] h-[199px] rounded-l-4xl bg-[#FFFFFF38] rotate-90"></div>
                        </div>
                    </div>
