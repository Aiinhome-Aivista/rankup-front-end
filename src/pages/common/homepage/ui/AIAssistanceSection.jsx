...
const AIAssistanceSection = ({ fadeContent = false }) => {
  ...
  return (
    <div className="relative px-4 md:px-10 text-app-primary-bg py-10 bg-app-primary-bg">
      <div className="absolute top-[5%] right-[-2%] left-[70%] w-[30%] h-[90%] rounded-full bg-linear-to-br from-app-primary-55 to-app-primary-to-red blur-[100px]"></div>

      {/* <div className='absolute top-[5%] right-[-2%] left-[70%] w-[30%] h-[30%] rounded-full bg-linear-to-br from-[#F21D2F] to-[#514CF1] [100px]'></div> */}

      <div className="absolute top-[10%] left-[-5%] w-[40%] h-[90%] rounded-full bg-linear-to-br from-app-primary-55 to-app-primary-to-red blur-[100px]"></div>

      <div className="absolute bottom-[-2%] left-1/2 -translate-x-1/2 w-[40%] h-[40%] rounded-full bg-linear-to-br from-app-primary-55 to-app-primary-to-red blur-[100px]"></div>
      ...
      >
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-app-primary-bg font-extrabold text-6xl">
            AI Assistance
          </h1>
          <div className="absolute left-1/2 -translate-x-1/2 w-[60%] h-[15%] rounded-full bg-linear-to-br from-app-primary-55 to-app-primary-to-red blur-[80px] pointer-events-none -z-10"></div>

          <p className="text-lg font-normal text-app-primary-bg">
        ...
        <div className="relative grid grid-cols-1 md:grid-cols-12 gap-6 w-full">
          <div className="absolute inset-0 left-1/2 -translate-x-1/2 w-full h-full rounded-full bg-linear-to-br from-app-primary-55 to-app-primary-to-red blur-[120px] pointer-events-none -z-10"></div>
          ...
          >
            <div className="w-full h-full text-app-primary-5 rounded-3xl px-6 pb-6 border-3 border-app-primary-4 text-center backdrop-blur-xl shadow-[5px_12px_22px_4px_rgba(0,0,0,0.25)] flex flex-col items-center">
              ...
              <button
                className="mt-5 h-[33px] w-[118px] rounded-[20px]   text-app-primary-bg-190
                                                    text-lg
                                                    font-semibold
                                                    backdrop-blur-md
