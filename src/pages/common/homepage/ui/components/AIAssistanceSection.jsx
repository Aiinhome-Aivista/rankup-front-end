...
const AIAssistanceSection = () => {
    return (
        <div className='relative py-20 px-4 md:px-10 overflow-hidden text-white'>
            <div className='absolute inset-0 z-0 bg-linear-to-b from-[#FFFFFF] via-[#514CF1] to-[#5b42f3]'></div>
            ...
            <div className='relative z-10 max-w-3xl mx-auto flex flex-col items-center'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-12 gap-6 w-full'>
                    <div className='md:col-span-8'>
                        <div className='w-full h-full bg-white/10 backdrop-blur-md rounded-3xl p-8 border border-white/20 text-center shadow-xl flex flex-col justify-center items-center'>
                    ...
                    <div className='md:col-span-4 flex flex-col gap-6 h-full'>
                        <div className='flex-1 w-full bg-white/10 backdrop-blur-md rounded-3xl border border-white/20 shadow-xl min-h-[140px]'></div>
                        <div className='flex-1 w-full bg-white/10 backdrop-blur-md rounded-3xl border border-white/20 shadow-xl min-h-[140px]'></div>
                    </div>
                </div>
